...
CREATE TABLE `log_actiuni` (
  ...
  `Actiune` varchar(255) DEFAULT NULL,
...
--
-- Dumping data for table `log_actiuni`
--

LOCK TABLES `log_actiuni` WRITE;
/*!40000 ALTER TABLE `log_actiuni` DISABLE KEYS */;
/*!40000 ALTER TABLE `log_actiuni` ENABLE KEYS */;
UNLOCK TABLES;
